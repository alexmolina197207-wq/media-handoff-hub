...
export const demoMedia: MediaFile[] = [
  ...
  { id: 'm2', title: 'App walkthrough clip', type: 'video', tags: ['demo','product'], size: 18500000, folderId: 'f3', collectionId: 'c2', previewUrl: placeholderImg(400,300,1), videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', notes: '30s walkthrough for reels', uploadedAt: '2025-03-27T15:20:00Z', source: 'Screen Record' },
  ...
  { id: 'm5', title: 'TikTok draft — feature reveal', type: 'video', tags: ['tiktok','draft'], size: 24000000, folderId: 'f4', collectionId: null, previewUrl: placeholderImg(400,300,4), videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', notes: 'Needs voiceover', uploadedAt: '2025-03-23T16:10:00Z', source: 'Import' },
  ...
  { id: 'm8', title: 'Promo reel — spring sale', type: 'video', tags: ['promo','marketing'], size: 32000000, folderId: 'f3', collectionId: 'c1', previewUrl: placeholderImg(400,300,7), videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', notes: '15s version', uploadedAt: '2025-03-20T12:00:00Z', source: 'Upload' },
  ...
  { id: 'm10', title: 'Behind the scenes clip', type: 'video', tags: ['bts','culture'], size: 15000000, folderId: 'f5', collectionId: 'c3', previewUrl: placeholderImg(400,300,9), videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', notes: '', uploadedAt: '2025-03-18T10:15:00Z', source: 'Upload' },
  ...
  { id: 'm12', title: 'Onboarding tutorial', type: 'video', tags: ['tutorial','product'], size: 42000000, folderId: 'f3', collectionId: null, previewUrl: placeholderImg(400,300,11), videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', notes: '2min full tutorial', uploadedAt: '2025-03-16T09:00:00Z', source: 'Screen Record' },
];
